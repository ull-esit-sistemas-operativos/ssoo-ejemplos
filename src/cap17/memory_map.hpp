...
public:
    ...
    // Para reservar una región de la memoria virtual del proceso y mapear en ella el archivo,
    ...
    // descriptor de archivo; porque si uno de ellos es destruido, destruirá el recurso
