...
- [`sockets/`](sockets/) — _Sockets_ UDP: un servidor y un programa de control que se comunican a través de ellos, en versiones para POSIX y para la API de Windows.
